/* ===================== SHADI SALOON — translation strings =====================
   Split out of app.js on its own so the ~50-key AR/EN dictionary doesn't bury
   the actual app logic. Loaded before app.js (see app.html) and read via the
   global `t` object + the tr(key) helper defined in app.js. */
const t={ar:{
